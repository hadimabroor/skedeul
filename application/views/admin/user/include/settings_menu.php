	...
	<div class="card">
		<div class="card-body">
			<ul class="nav nav-pills flex-column" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link <?php if(isset($page_title) && $page_title == "Themes"){echo "active";} ?>" href="<?php echo base_url('admin/settings/themes') ?>"><i class="bi bi-palette mr-1"></i> <?php echo trans('theme-color') ?></a>
				</li>
				<li class="nav-item">
				...
				<?php if (settings()->global_twilio == 0): ?>
				<li class="nav-item">
				...
				<?php if (settings()->global_ultramsg == 0): ?>
				<li class="nav-item">
					<a class="nav-link <?php if(isset($page_title) && $page_title == "Whatsapp Settings"){echo "active";} ?>" href="<?php echo base_url('admin/settings/whatsapp') ?>"><i class="fab fa-whatsapp mr-1"></i> <?php echo trans('whatsapp').' '.trans('settings') ?></a>
				</li>
				<?php endif ?>
				...
				<li class="nav-item">
					<a class="nav-link <?php if(isset($page_title) && $page_title == "QR Settings"){echo "active";} ?>" href="<?php echo base_url('admin/settings/qr_code') ?>"><i class="fas fa-qrcode pl-1 mr-1"></i> <?php echo trans('qr-code') ?></a>
				</li>
				<?php endif; ?>
