...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      Skedeul &bull; Home &bull;   Business Service Booking Software
    </title>
    <link
      rel="shortcut icon"
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Create Your Website And Start Accepting Online Bookings For Your Business
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
                Create booking pages, manage appointments, connect with your customers online using zoom or google-meet accept payments, and many more features.
              </p>
              <ul
              ...
              >
                <li>
                  <a
                    href="https://skedeul.com/pricing?trial=start"
                ...
                <li>
                  <a
                    href="https://skedeul.com/zphyr-labs"
                    target="_blank"
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                You will get a ready to use booking site after signup in Skedeul
              </p>
              <a
                href="javascript:void(0)"
            ...
            <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
              ...
              >
                <span
                  class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <i class="fa-regular fa-calendar-check fa-2xl" style="color: #ffffff;"></i>
              </div>
              <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                Accept online bookings
              </h4>
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Accept bookings from your clients using your own booking site.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Your Staffs & Clients will get access to their own portal.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
            ...
            <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
              ...
              >
                <span
                  class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <i class="fa-solid fa-credit-card fa-2xl" style="color: #ffffff;"></i>
              </div>
              <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                Accept Payments
              </h4>
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Accept Online / Offline payments from your clients.
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
          ...
          <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  Brilliant Toolkit To Take Your Business To New Heights.
                </h2>
                <p
          ...
          <div class="-mx-4 flex flex-wrap items-stretch">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                  Take your business to new heights with seamless website creation and online booking solutions.
                </p>
                <a
                  href="https://skedeul.com/pricing?trial=start"
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    “This platform transformed our booking process! Setting up the website was incredibly easy, and our clients love the seamless booking experience."
                  </p>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    "Our bookings have doubled since switching to this service. The intuitive design and user-friendly interface made all the difference."
                  </p>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    "As a small business owner, I needed a reliable and simple solution to manage online bookings. This platform delivered beyond my expectations!"
                  </p>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    "The efficiency and ease of use have been game-changers for our business. Customers appreciate the convenience of booking online, and we love the increased traffic!" 
                  </p>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <p class="mb-6 text-base text-body-color dark:text-dark-6">
                    "This product streamlined our entire booking process. The customer support is fantastic, and our clients find it so easy to book appointments online."
                  </p>
          ...
          <div class="w-full px-4 lg:w-1/2">
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color dark:text-dark-6">
                  Our 14 day trial is 100% free and does not require any credit card information to start. If at the end of your trial you would like to upgrade, great. If not, your plan will automatically be downgraded to the free plan.
                </p>
              </div>
            </div>
            <div class="mb-12 flex lg:mb-[70px]">
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          ...
          <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
            ...
            >
              ...
              <form method="post" action="https://skedeul.com/home/send_message">
                <div class="mb-[22px]">
                  <label
                    for="fullName"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              <div class="-mx-3 flex items-center">
                <a
                  target="_blank" href="<?= prep_url($settings->facebook) ?>"
          ...
          if(logo.length) {
            ...
            if (ud_header.classList.contains("sticky")) {
              document.querySelector(".header-logo").src =
                "assets/assets/images/logo/logo.png"
            } else {
              document.querySelector(".header-logo").src =
                "assets/assets/images/logo/logo-white.png"
            }
          }
